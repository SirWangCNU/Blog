          ...
          >
            ...
            >
              ...
              <div className="sticky top-0 bg-card border-b border-border p-6 flex justify-between items-start z-10">
                ...
                <button
                  onClick={() => setShowModal(false)}
                  className="text-foreground-secondary hover:text-foreground transition-colors p-2 hover:bg-muted rounded-lg"
                >
              ...
              <div className="p-6">
                {/* Project Hero Image */}
                <div className="w-full h-48 bg-gradient-to-br from-primary/20 to-accent/20 rounded-xl mb-6 flex items-center justify-center">
